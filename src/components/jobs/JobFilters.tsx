...
export function JobFilters({
  ...
  return (
    <div className={`space-y-4 ${disabled ? 'opacity-50 pointer-events-none' : ''}`}>
      {/* Search Bar */}
      <div className="flex">
        <div className="flex-1 flex items-center bg-white border border-gray-200 border-r-0 px-3">
        ...
        <button
          ...
          className="sm:hidden px-4 py-2.5 bg-white border border-gray-200 border-l-0 text-gray-700 hover:bg-gray-50 transition-colors"
