...
export const sectors: Sector[] = [
  ...
  },
  {
    ...
    positions: [
      { id: 'remedial-diagnostic-engineer', name: 'Remedial & Diagnostic Engineer' },
      { id: 'remedial-consultant', name: 'Remedial Consultant' },
      { id: 'remedial-project-manager', name: 'Remedial Project Manager' },
      { id: 'building-consultant', name: 'Building Consultant' },
      { id: 'estimator', name: 'Estimator' },
      { id: 'remedial-site-manager', name: 'Remedial Site Manager' },
      { id: 'remedial-drafter', name: 'Remedial Drafter' },
    ],
  },
  {
    id: '4',
    ...
    positions: [
      ...
      { id: 'showroom-sales', name: 'Showroom Sales' },
      { id: 'sales-representative', name: 'Sales Representative' },
      { id: 'internal-sales', name: 'Internal Sales' },
